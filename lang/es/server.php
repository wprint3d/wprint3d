...
return [
    ...
    'printers' => [
        ...
        'mapper_running' => 'No se pudo completar la acción: el mapeador está en ejecución. Vuelve a intentarlo en unos segundos.',
        'unknown_node' => 'No conocemos el nodo de esta impresora. Desconecta el cable USB y vuelve a conectarlo, espera unos segundos y vuelve a intentarlo.',
    ...
    'users' => [
        'permission_denied' => 'No tienes los permisos necesarios.',
        ...
        'role_change_forbidden' => 'No puedes cambiar el rol de este usuario.',
        'delete_forbidden' => 'No puedes eliminar a este usuario.',
    ],
    'plugins' => [
        'invalid_upload' => 'El paquete subido no es válido.',
        'install_source_required' => 'Proporciona un paquete, una URL, un unpackedPath o un pluginId del registro.',
