...
class RefreshPrinterWorkers extends ConcurrentService
{
    ...
    protected function refreshWorkers(array $queues, int $sleepSecs): bool
    {
        ...
        $didUpdateScalableWorkers = $this->createScalableWorkers($queues, $sleepSecs);
        $didUpdatePerPrinterWorkers = $this->createPerPrinterWorkers($queues, $sleepSecs);

        return $didUpdateScalableWorkers || $didUpdatePerPrinterWorkers;
    }
