...
class InstallUpdates extends Command
{
    ...
    private function pullImages(): void
    {
        ...
        $process = Process::path($this->composeDir)->start(
            $this->runtime->composeCommand(['pull'])
        );
    ...
    private function applyUpdates(): void
    {
        ...
        $process = Process::path($this->composeDir)->start(
            $this->runtime->composeCommand(['down'])
        );
        ...
        $process = Process::path($this->composeDir)->start(
            $this->runtime->composeCommand(['up', '-d'])
        );
    ...
    public function installUpdate(): void
    {
        ...
        $this->composeDir = $this->runtime->composeDir();
